...
export const settingsApi = {
  ...
  setGoogleAiKey: (key: string): Promise<{ success: boolean; message: string }> =>
    api.post('/api/settings/google-ai-key', { key }).then(r => r.data),
  setRunwayKey: (key: string): Promise<{ success: boolean; message: string }> =>
    api.post('/api/settings/runway-key', { key }).then(r => r.data),
  setLumaKey: (key: string): Promise<{ success: boolean; message: string }> =>
    api.post('/api/settings/luma-key', { key }).then(r => r.data),
  setHeyGenKey: (key: string): Promise<{ success: boolean; message: string }> =>
    api.post('/api/settings/heygen-key', { key }).then(r => r.data),
  setFalKey: (key: string): Promise<{ success: boolean; message: string }> =>
    api.post('/api/settings/fal-key', { key }).then(r => r.data),
  setStabilityKey: (key: string): Promise<{ success: boolean; message: string }> =>
    api.post('/api/settings/stability-key', { key }).then(r => r.data),
